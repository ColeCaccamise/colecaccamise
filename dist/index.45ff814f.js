...
})({"3lQv1":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "88e6bd4800c70e1ebe14e33745ff814f"; // @flow
...
},{}],"7F2aS":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
var process = require("process");
var __dirname = "/Users/colecaccamise/Projects/portfolio/colecaccamise new/node_modules/fontawesome";
...
async function generate() {
    ...
    if (version.length < 3) throw new Error("Couldn't parse version");
    ...
    var packageInfo = Buffer.from("", "base64").toString();
    packageInfo = packageInfo.replace(/(\"version\":\s*\")[\d.]+\"/, "$1" + packageVersion + "\"");
    require("fs").writeFileSync(__dirname + "/package.json", packageInfo);
}
generate().then(()=>console.log("Successfully generated new index.js")
).catch((err)=>console.error(err)
);

},{"buffer":"3susO","process":"7AgFc","https":"40LTh","fs":"2RD6T"}],"3susO":[function(require,module,exports) {
/*!
...
},{}],"40LTh":[function(require,module,exports) {
module.exports = require("./loaders/browser/js-loader")(require('./bundle-url').getBundleURL() + "https-browserify.ea4c360a.js").catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root('5cL8c')
);

},{"./loaders/browser/js-loader":"2Ucmd","./bundle-url":"3seVR"}],"2Ucmd":[function(require,module,exports) {
...
},{"../../cacheLoader":"4zpnH"}],"4zpnH":[function(require,module,exports) {
"use strict";
let cachedBundles = {
};
let cachedPreloads = {
...
},{}],"3seVR":[function(require,module,exports) {
"use strict";
...
},{}]},["3lQv1","7F2aS"], "7F2aS", "parcelRequire3803")

//# sourceMappingURL=index.45ff814f.js.map
