				...
				<div className='flex flex-col gap-4'>
					<div>
						<div className='flex flex-col gap-3'>
							...
							<span className='bg-ui-component-default w-fit py-2 px-4 rounded-md'>
								{capitalize(meta?.category || '')}
							</span>
						</div>

						<div className='container py-4 flex flex-col gap-4'>{content}</div>
					</div>
					...
					<div className='flex flex-col gap-4'>
						...
						{meta?.demoLink && (
							<Button
								variant='unstyled'
								className='w-full btn btn-contrast font-medium'
							>
								Live Demo
							</Button>
						)}
