        ...
        <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
          {enterManually && (
            <>
              ...
              />
              <div className="flex flex-col gap-6">
                <Button loading={loading} disabled={!code}>
          ...
          <div className="text-text2 flex w-full flex-col items-center justify-center gap-4">
            {!enterManually && isValidEmail(email || "") && (
              <Button variant="link" handleClick={() => setEnterManually(true)}>
                Enter code manually
              </Button>
            )}

            <Button variant="link" href="/admin/login">
              Back to login
            </Button>
          </div>
        </form>
